...
then
    ...
    --ui-buttonmap a^autofire:10:500=KEY_LEFTCTRL,b^autofire:10:500=KEY_LEFTALT,x=KEY_SPACE,y=KEY_LEFTSHIFT,lb=KEY_Z:KEY_TAB:900,rb=KEY_X:KEY_ENTER:900 \
...
then
    ...
    --evdev-keymap BTN_SOUTH=a,BTN_EAST=b,BTN_NORTH=x,BTN_WEST=y,BTN_TL=lb,BTN_TR=rb,BTN_THUMBL=tl,BTN_THUMBR=tr,BTN_MODE=guide,BTN_SELECT=back,BTN_START=start,BTN_TRIGGER_HAPPY3=du,BTN_TRIGGER_HAPPY4=dd,BTN_TRIGGER_HAPPY1=dl,BTN_TRIGGER_HAPPY2=dr \
    --evdev-absmap ABS_HAT0X=dpad_x,ABS_HAT0Y=dpad_y \
    --ui-buttonmap a^autofire:10:500=KEY_LEFTCTRL,b^autofire:10:500=KEY_SPACE,x=KEY_LEFTALT,y=KEY_LEFTSHIFT,lb=KEY_Z,rb=KEY_X \
...
then
    ...
    --ui-buttonmap start=KEY_V+KEY_ENTER,back=KEY_C,back+x=KEY_ESC,back+start=exec:/opt/retropie/supplementary/xboxdrv/bin/quit.sh,back+lb=KEY_F2,back+rb=KEY_F1 \
    --ui-buttonmap du=KEY_UP,dd=KEY_DOWN,dl=KEY_LEFT,dr=KEY_RIGHT \
&
fi
