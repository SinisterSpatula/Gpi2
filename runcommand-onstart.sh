...
then
    ...
    --ui-buttonmap x=KEY_RIGHTCTRL,a=void,b=KEY_SPACE+KEY_E,y=KEY_LEFTSHIFT,lb=KEY_A,rb=KEY_D,a+lb=KEY_SEMICOLON,a+rb=KEY_APOSTROPHE,lb+rb=KEY_LEFTCTRL,rb+lb=KEY_LEFTCTRL \
